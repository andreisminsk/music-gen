...
# Build:  docker build -t ghcr.io/andreisminsk/music-gen:0.1.0 .
# Run:    docker run --gpus all -v ./output:/app/output ghcr.io/andreisminsk/music-gen:0.1.0 generate --style "Jazz" --lyrics "..."
